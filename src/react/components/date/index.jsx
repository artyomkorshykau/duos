    ...
    <DatePicker
      ...
      icon = {
        <svg width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
          <rect x="1.33203" y="3" width="14" height="2" rx="1" fill="#7C92A7"/>
          <rect x="4.33203" y="1" width="2" height="4" rx="1" fill="#7C92A7"/>
          <path fill-rule="evenodd" clip-rule="evenodd"
                ...
                fill="#7C92A7"/>
          <rect x="10.332" y="1" width="2" height="4" rx="1" fill="#7C92A7"/>
        </svg>
      }
      showIcon
